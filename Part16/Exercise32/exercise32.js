...
//adding image into the example bar graph
//append image to graph svg
//take image from raw of github url
//assign attributes to position the size and location of the image
var myimage = graph.append('image')
    .attr('xlink:href', "https://raw.githubusercontent.com/eniolubifaleye/F21DV/main/doublestarframe-1919.svg")
    .attr('width', 300)
    .attr('height', 300)
    .attr("x", -50)
    .attr("y",-70);
...
var bar = graph.selectAll("g") 
      ...
      .attr("transform", function(d, i) { 
        return "translate(70," + ((i * barHeight)+20)  + ")" 
      }); 
